...
Gem::Specification.new do |spec|
  spec.name          = "dev-portfolio-projectz"
  spec.version       = "0.1.8"
  spec.authors       = ["Rohit Jain"]
  spec.email         = ["rohitjain18005@gmail.com"]

  spec.summary       = "This is a simple efficient projectz and portfolio"
  spec.homepage      = "https://github.com/rohitjain00/dev-portfolio-projectz"
  spec.license       = "MIT"

  spec.files = `git ls-files -z`.split("\x0").select do |f|
    f.match(%r!^(projectz|assets|_(includes|layouts|sass)/|(LICENSE|README)((\.(txt|md|markdown)|$)))!i)
  end
